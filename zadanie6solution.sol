...
import "./abstractContract2.sol";

contract BettingContractV6 is AbstractContract2 {
  ...
  function guess(uint8 num, string name) public payable returns (bool){
    ...
    // bet akceptowany tylko jesli balance > 3*MAX_BET
  ...
  // dodanie opcji do wyplaty z contractu dla ownera
